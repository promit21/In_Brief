...
const TopCreators = () => {
    const fakeData=[
        {
            image:'https://img.freepik.com/free-photo/portrait-man-laughing_23-2148859448.jpg?size=338&ext=jpg&ga=GA1.1.386372595.1726531200&semt=ais_hybrid',
            name:"Alex Young",
            chanel:"BBC News" 
        },
        {
...
<p className='text-red-600 font-medium'>{creator.chanel}</p>
            </div>
          </div>
        ))}
      </div>
